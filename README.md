...
```bash
cd backend
python -m pytest -q      # 149 tests (analytics + API security + rate-limit contract + error disclosure + research integrity + resource bounds)
```
